...
感性理解一下，以后缀链接树的等价类作为节点产生的 DFA，应当也是**最小的 DFA**。~~主要是我不会证~~。OI-Wiki 说 [Myhill–Nerode 定理](https://oi-wiki.org/misc/fsm/#myhillnerode-%E5%AE%9A%E7%90%86)可以证明这一点。这意味着 SAM 是一个极其优雅的结构——它是字符串与生俱来最小的结构。
